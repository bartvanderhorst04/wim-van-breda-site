...
addPage({ url: '/', page_type: 'home', slug: '', h1: 'De meest effectieve machines voor berm, sloot, tuin en park', seo_title: 'Machines voor groen- en terreinbeheer | Wim van Breda', meta_description: 'Wim van Breda levert, onderhoudt en verhuurt professionele machines voor groen-, berm- en terreinbeheer. Nieuw, occasion en verhuur uit Geldermalsen.', canonical: BASE + '/', og_title: 'Machines voor groen- en terreinbeheer | Wim van Breda', og_description: 'Wim van Breda levert, onderhoudt en verhuurt professionele machines voor groen-, berm- en terreinbeheer. Nieuw, occasion en verhuur uit Geldermalsen.', schema_type: 'Organization,WebSite' });
...
const FIXED_PAGES = [
  ...
  { page: 'occasions', url: '/occasions/', h1: 'Occasions', type: 'listing', t: 'Occasions: gebruikte machines | Wim van Breda', d: 'Gebruikte machines voor groen- en terreinbeheer, technisch nagekeken in onze eigen werkplaats. Filter op merk en type.' },
